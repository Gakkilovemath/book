...
void bootstrap(double A, double B, int NumIt, int N, int n, int K, int ngrid, double grid[], double data[], double x2[], double data2[], int delta[], int delta2[], int **freq2, double **p2,
